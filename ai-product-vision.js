...
const BASE_PROMPT = [
  ...
  "",
  "OBLIGATOIRE — quand category === 'sports_card', tu DOIS remplir SÉPARÉMENT",
  "les 5 champs pivots (même si l'info se répète dans product_name / variant) :",
  "  - player       : nom du joueur (prénom + nom si lisibles)",
  "  - card_year    : année d'émission (ex '2023' ou '2023-24')",
  "  - card_brand   : marque éditrice (Panini, Topps, Upper Deck, Futera...)",
  "  - card_set     : nom du set (Prizm, Select, Mosaic, Optic, Chrome, Donruss,",
  "                    Immaculate, Contenders, Score, Hoops, Origins, Obsidian...)",
  "  - card_number  : numéro dans le set (ex '136', avec ou sans '#')",
  "",
  "Ces 5 champs pilotent la recherche de prix eBay. S'ils sont vides, la",
  "recherche eBay ne peut PAS être construite et l'utilisateur ne verra qu'une",
  "estimation approximative. Un champ vide est une DÉGRADATION UX — remplis-les",
  "dès que tu as le moindre indice (image + titres Lens).",
  "",
  ...
  "  en priorité pour extraire les 5 champs pivots ci-dessus, MAIS vérifie la",
