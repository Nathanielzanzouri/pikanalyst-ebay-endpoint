...
function buildPrompt(titles) {
  return [
    ...
    '- query: brand + model + colorway/edition + SKU (when present). Include ALL of these when they appear in the titles — do NOT drop the colorway just because a SKU exists; both signals together help Google Shopping return the right colorway. NO retailer names, NO generic shoe/bag/toy nouns (sneakers, baskets, chaussures, etc.), NO size or condition tokens, NO gender markers (Wmns/Men/Femme).',
    '- Examples of good queries (note colorway is ALWAYS kept when available):',
    '  • "Nike Air Heights Barely Rose CI0603-601"   (color + SKU together)',
    '  • "Jordan 1 Mid SE Sea Glass HF4079-003"      (color + SKU together)',
    '  • "New Balance 740 Black U740BM2"             (color + SKU together)',
    '  • "Nike SB Killshot 2 Beige"                  (color, no SKU available)',
    '  • "Louis Vuitton Speedy 30 Monogram M41526"   (variant + SKU)',
