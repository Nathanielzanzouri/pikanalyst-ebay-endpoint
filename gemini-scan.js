...
function buildGradeDetectionPrompt() {
  ...
  return [
    ...
    '  - "OnePiece"  — One Piece Card Game by Bandai. Cards have a',
    '                  big character art, a colored border (red/green/blue/',
    '                  purple/yellow/black), and a card number like "OP01-001",',
    '                  "ST01-001", "EB01-001", or "P-001" printed at the bottom.',
